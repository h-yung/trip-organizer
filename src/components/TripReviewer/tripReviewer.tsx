...
return (
    ...
    >
            ...
            {allTripActivities.map((activity:ActionItem) => {
                ...
                return (
                    ...
                    <div 
                        key={activity._id}
                    >
                    <label className="item-label">{activity.title}</label>
                    ...
                    <Rate
                        value={
                            (activity._id! in formVals) ? formVals[activity._id as keyof object] as number : 2.5
        ...
        <Form.Item className="form-item" name="recommend" 
                //  rules={[{ required: true }]}
        >
            <Checkbox 
